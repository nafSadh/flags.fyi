    ...
    <section class="section main-content container">
      <div class="buttons">
        <button
          ...
          :key="flagId"
          class="button is-rounded is-light py-0 pl-0 pr-4
                level is-mobile "
        >
        ...
        >
          <div class="card">
            <div class="card-image">
              <div class="card-content has-background-light py-2">
                {{ flagId }}
              </div>
              <figure class="image">
                <img
                  :src="require('~/assets/export/' + `${flagData.svg}`)"
      ...
      <span v-for="(flagData, flagId) in flagsJson" :key="flagId">
        <span class="is-size-4">
          <span class="icon is-medium">
            <img :src="require('~/assets/export/' + `${flagData.svg}`)" />
          </span>
          {{ flagId }}
        </span>
      </span>
